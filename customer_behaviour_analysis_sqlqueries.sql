...
select customer_id ,gender, purchase_amount from customer where discount_applied ='Yes' 
...
select customer_segment, count(*) as number_of_customers from cte group by customer_segment
